    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', padding: '1rem 0' }}>
      <div className="login-portal-container">
        ...
        <div className="login-portal-form-side">
          ...
          {/* Devices Sync Control (visible on login portal) */}
          <div style={{
            marginTop: '1.5rem',
            paddingTop: '1rem',
            ...
            {!showSyncInput ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', width: '100%', alignItems: 'stretch' }}>
                <span style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-secondary)' }}>Enter Cloud Sync Key from laptop settings:</span>
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  ...
                  <button
                    ...
                    className="btn btn-primary"
                    onClick={async () => {
                      if (!inputSyncKey.trim()) {
                        alert('Please enter a valid key.');
                        return;
                      }
                      const result = await connectCloudSync(inputSyncKey.trim());
                      if (result.success) {
                        alert('Real-time sync established successfully! Database has been updated.');
